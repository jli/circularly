...
// The less-hacky way of doing things:
// include   <script src="https://www.universe.com/embed2.js"></script>
// do        $u.open('PHZ7GC', { accessKeys: keys });

// The more-hacky way:
// const i = document.createElement('iframe');
// i.classList.add('fullscreen');
// i.id = 'universe-8d1b1842-0b81-490f-a3ea-5c9ed094aaa8';
// i.src = construct_url(keys);
// const h = document.querySelector('#hackform');
// h.appendChild(i);

function _construct_state(access_keys) {
  let key_counts;
  ...
  for (let [key, count] of Object.entries(key_counts)) {
...
function construct_url(access_keys) {
  ...
  const state = _construct_state(access_keys);
